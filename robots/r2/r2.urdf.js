...
robot.endeffector = {};
robot.endeffector.frame = "r2_fixed_waist_center_body_cover";
...
robot.joints.r2_waist_joint0.axis = [0,0,1];
...
robot.joints.r2_fixed_waist_center_left_shoulder_jr3.axis = [0,0,0];
robot.joints.r2_fixed_waist_center_left_shoulder_jr3.type = "fixed";
robot.joints.r2_fixed_waist_center_left_shoulder_jr3.origin = {xyz: [-0.02,0.03,0], rpy:[0.3,-1.57,0]};
...
robot.joints.r2_fixed_left_wrist_yaw_left_palm.axis = [0,0,1];
...
robot.joints.r2_left_arm_hand_index_proximal.origin = {xyz: [0.09,0.03, 0 ], rpy:[1.5708, 1.57, 0.0 ] };

robot.joints.r2_fixed_waist_center_right_shoulder_jr3= {parent:"r2_waist_center", child:"r2_right_arm_shoulder_jr3"};
robot.joints.r2_fixed_waist_center_right_shoulder_jr3.axis = [0,0,0];
robot.joints.r2_fixed_waist_center_right_shoulder_jr3.type = "fixed";
robot.joints.r2_fixed_waist_center_right_shoulder_jr3.origin = {xyz: [0.15,0.02,0], rpy:[0.3,1.57,0]};
...
robot.joints.r2_fixed_right_wrist_yaw_right_palm.axis = [0,0,1];
...
robot.joints.r2_right_arm_hand_index_proximal.origin = {xyz: [0.09,0.03, 0.0 ], rpy:[1.5708, 1.57, 0.0 ] };
...
robot.joints.r2_neck_joint1.type = "revolute";
